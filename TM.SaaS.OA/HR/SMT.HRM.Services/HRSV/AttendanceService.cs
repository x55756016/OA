...
namespace SMT.HRM.Services
{
    public partial class OrganizationService
    {
        ...
        [OperationContract]
        public void SaveFileReturnFilePath(UploadFileModel UploadFile, out string strFilePath)
        {
        ...
        public byte[] ExportEmployeesAttendanceeEntity(string ownerId, string ownerCompanyId, string startDate, string endDate)
        {
            using (AbnormRecordBLL bllAttRd = new AbnormRecordBLL())
            {
                return bllAttRd.ExportEmployeesAttendanceeEntity(ownerId, ownerCompanyId, startDate, endDate);
            }
        }
