    ...
    public class RoleEntityMenuBLL: BaseBll<T_SYS_ROLEENTITYMENU>
    {
        ...
        private T_SYS_ROLEENTITYMENU AddRoleEntityInfo(string EntityID, string StrRoleID)
        {
            try
            {
                ...
                Childrolemenu.T_SYS_ENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ENTITYMENU", "ENTITYMENUID", EntityID);

                Childrolemenu.T_SYS_ROLEReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLE", "ROLEID", StrRoleID);
        ...
        private T_SYS_ROLEENTITYMENU UpdateRoleEntityInfoByRoleEntityID(T_SYS_ROLEENTITYMENU RoleEntityObj)
        {
            try
            {
                ...
                Childrolemenu.T_SYS_ENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ENTITYMENU", "ENTITYMENUID", RoleEntityObj.T_SYS_ENTITYMENU.ENTITYMENUID);
                Childrolemenu.T_SYS_ROLEReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLE", "ROLEID", RoleEntityObj.T_SYS_ROLE.ROLEID);
                Childrolemenu.UPDATEDATE = null;
                Childrolemenu.UPDATEUSER = "";
                Childrolemenu.CREATEDATE = System.DateTime.Now;
                Childrolemenu.CREATEUSER = "admin";
        ...
        private bool RoleEntityMenuPermissionAdd(string tmpString, string StrRoleID, string StrAddUser)
        {
            try
            {
                ...
                for (int i = 0; i < firstStr.Length; i++)
                {
                    ...
                    T_SYS_ROLEENTITYMENU rolemenu = new T_SYS_ROLEENTITYMENU();
                    rolemenu.ROLEENTITYMENUID = System.Guid.NewGuid().ToString();
                    rolemenu.T_SYS_ENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ENTITYMENU", "ENTITYMENUID", EntityID);
                    //rolemenu.T_SYS_ENTITYMENU.ENTITYMENUID = EntityParentID;
                    rolemenu.T_SYS_ROLEReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLE", "ROLEID", StrRoleID);
            ...
            try
            {
                ...
                for (int p = 0; p < PermissionEntitis.Length - 1; p++)
                {
                    ...
                    if (!string.IsNullOrEmpty(StrDataRange))
                    {
                        ...
                        PermRole.T_SYS_PERMISSIONReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_PERMISSION", "PERMISSIONID", StrPermissionID);

                        PermRole.T_SYS_ROLEENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLEENTITYMENU", "ROLEENTITYMENUID", rolemenu.ROLEENTITYMENUID);
                    ...
                    if (ChildMenu == null) //为空则添加
                    {
                        ...
                        for (int p = 0; p < PermissionEntitis.Length - 1; p++)
                        {
                            ...
                            if (!string.IsNullOrEmpty(StrDataRange))
                            {
                                ...
                                PermRole.DATARANGE = StrDataRange;
                                PermRole.T_SYS_PERMISSIONReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_PERMISSION", "PERMISSIONID", StrPermissionID);
                                PermRole.T_SYS_ROLEENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLEENTITYMENU", "ROLEENTITYMENUID", Childrolemenu.ROLEENTITYMENUID);
                                PermRole.CREATEDATE = System.DateTime.Now;
                                PermRole.CREATEUSER = StrAddUser;
                                PermRole.UPDATEDATE = null;
                                PermRole.UPDATEUSER = "";
                            ...
                            { //修改
                                if (!string.IsNullOrEmpty(StrDataRange))
                                {
                                    if (StrDataRange != ExistRecord.DATARANGE)
                                    {
                                        ...
                                        PermRole.T_SYS_PERMISSIONReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_PERMISSION", "PERMISSIONID", StrPermissionID);
                                        PermRole.T_SYS_ROLEENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLEENTITYMENU", "ROLEENTITYMENUID", ChildMenu.ROLEENTITYMENUID);
        ...
        public List<string> GetDepartmentIDs(string companyId)
        {
            ...
            try
            {
                ...
                List<T_HR_DEPARTMENT> LstDepartment = depBll.GetDepartmentActivedByCompanyID(companyId).ToList<T_HR_DEPARTMENT>();
