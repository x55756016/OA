    ...
    public class Utility
    {
        ...
        void initEntityRelation()
        {
            if (EntityRelation == null)
            {
                ...
                EntityRelation.Add("T_HR_EMPLOYEESALARYPOSTASIGN", "EmployeeBalancePostBLL");
            }
        }
        /// <summary>
        /// 克隆对像
        ...
        ///  获取版本配置信息：航信还是集体本部
        /// </summary>
        /// <param name="AppConfigName">isForHuNanHangXingSalary</param>
        /// <returns></returns>
        public static string GetAppConfigByName(string AppConfigName)
        {
